...
initial = np.array([1.0, 10.0, 4.0, -2.6, 1.0])  # initial guess for parameters
...
if __name__ == "__main__":
    ...
    print("MCMC sampling completed and saved to mcmc_100000.npz")   # Print completion message

    # Plot the results
    figure = corner.corner(flat_samples, labels=["ge", "gg", "logMe", "gc", "n"], 
                       quantiles=[0.16, 0.5, 0.84], 
                       show_titles=True, smooth=True, title_kwargs={"fontsize": 15})
    plt.savefig("chains/mcmc_100000.pdf")  # Save the corner plot
    plt.show()  