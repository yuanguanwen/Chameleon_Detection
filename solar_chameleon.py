...
def Rate_cham(wobs_array, ge, gg, logMe, gc, n, use_skew=False):   
    ...
    w_true_grid = np.linspace(w_true_min, w_true_max, 400) # keV
...
wobs_array = np.linspace(0.1, 30, 100)  # [keV]
events_mod1 = Rate_cham(wobs_array, ge=1.0, gg=9.4, logMe=4.0, gc=-2.62, n=1, use_skew=False)  # Gaussian resolution
# print(events_mod1)
...
plt.plot(wobs_array, events_mod1+bkg(wobs_array), label=r"${\rm B_0+Solar~chameleons}$", color='blue', linestyle="--", linewidth=2.5)
